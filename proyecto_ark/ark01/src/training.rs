...
//   - De-cuantización al vuelo (FP16 -> FP32) para Backward en CPU.
//   - Backward direccional en CPU (Accelerate/AMX, FP32).
//   - Zero-Copy AdamW: El optimizador (ASM NEON) escribe directamente
...
extern "C" {
    // Kernel ASM NEON para de-cuantizar pesos de FP16 a FP32 ultra rápido
    fn ark_dequant_f16_to_f32(src: *const u16, dst: *mut f32, n: u64);
}
    ...
    fn train_step(&mut self, tokens: &[u32]) -> anyhow::Result<Option<f32>> {
        ...
        unsafe {
            ...
            for l in 0..cfg.n_layers {
                ...
                ark_dequant_f16_to_f32(gpu_l.wo_fp16, tmp_l.wo.as_mut_ptr(), (d * d) as u64);
                ark_dequant_f16_to_f32(gpu_l.w1_fp16, tmp_l.w1.as_mut_ptr(), (d * h) as u64);
                ark_dequant_f16_to_f32(gpu_l.w3_fp16, tmp_l.w3.as_mut_ptr(), (d * h) as u64);
                ark_dequant_f16_to_f32(gpu_l.w2_fp16, tmp_l.w2.as_mut_ptr(), (h * d) as u64);
                ark_dequant_f16_to_f32(gpu_l.g1_fp16, tmp_l.g1.as_mut_ptr(), d as u64);
                ark_dequant_f16_to_f32(gpu_l.g2_fp16, tmp_l.g2.as_mut_ptr(), d as u64);
            }
        }
