...
// ============================================================
// attention_softmax_f32 (Versión de Árbol Robusta y Compatible)
//
// Softmax estable que funciona en todas las versiones de macOS y Metal.
// No requiere soporte intrínseco de SIMDgroup a nivel de hardware.
// ============================================================
